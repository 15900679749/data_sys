...
<!--	
		...
		<el-row>
			<el-col :span="8">
				<el-button id="login" @click='loginin' type="primary">登录</el-button>
			</el-col>
		</el-row>-->
	...
	export default {
		data() {
			return {
				...
				rules:{
					username:[
					{required:true,message:'请输入用户名',trigger:'blur',customClass:'user-input-class'}
					],
					password:[
					{required:true,message:'请输入密码',trigger:'blur',customClass:'user-input-class'}
					],
				},
				show:false,
